...
class StartRequest(BaseModel):
    ...
    sim_start_time: datetime = Field(..., description="Scenario start time.")
    sim_stop_time: datetime = Field(..., description="Scenario end time.")
    start_time: Optional[datetime] = Field(None, description="Wallclock start time.")
    ...
    time_status_init: Optional[datetime] = Field(
        None, description="Scenario time of the first time status (heartbeat) message."
    )
...
class UpdateRequest(BaseModel):
    ...
    sim_update_time: datetime = Field(..., description="Scenario update time.")
    ...
    def to_manager_format(self) -> manager.TimeScaleUpdate:
        ...
        """
        return manager.TimeScaleUpdate(self.time_scale_factor, self.sim_update_time)
